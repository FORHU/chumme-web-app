...
const recentActivity = [
  ...
  {
    id: "2",
    text: "Anna Lee joined BTS Sing Along room",
    time: "15 minutes ago",
  },
  ...
  {
    id: "5",
    text: "Mike Johnson liked 'Dynamite' recording",
    time: "5 hours ago",
  },
];
...
export function ProfilePage() {
  ...
  const [activeTab, setActiveTab] = useState<
    "overview" | "users" | "recordings" | "reports" | "featured" | "analytics"
  >("overview");
  ...
  return (
    ...
    >
      ...
      {/* Tab Navigation */}
      <div
        className={`flex gap-2 border-b ${isDarkMode ? "border-gray-700" : "border-gray-200"}`}
      >
        {[
      ...
      <div className="mt-6">
        ...
        {activeTab === "users" && (
          <UsersTab isDarkMode={isDarkMode} users={mockUsers} />
        )}
        {activeTab === "recordings" && (
          <RecordingsTab isDarkMode={isDarkMode} recordings={mockRecordings} />
        )}
        {activeTab === "reports" && (
          <ReportsTab isDarkMode={isDarkMode} reports={mockReports} />
        )}
        {activeTab === "featured" && (
          <FeaturedTab isDarkMode={isDarkMode} artists={mockFeaturedArtists} />
        )}
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-4">
        <div
          className={`p-3 rounded-xl ${isDarkMode ? "bg-[#A53860]/20" : "bg-[#A53860]/10"}`}
        >
          <Icon
            className={`w-6 h-6 ${isDarkMode ? "text-[#EF88AD]" : "text-[#A53860]"}`}
          />
        </div>
      </div>
      <h3
...
function OverviewTab({ isDarkMode }: { isDarkMode: boolean }) {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      {/* Recent Activity */}
      <div
        className={`${isDarkMode ? "bg-gray-800/80 border-gray-700/50" : "bg-white/80 border-gray-200/50"} backdrop-blur-xl rounded-2xl p-6 border`}
      >
        <h3
        ...
        <div className="space-y-4">
          {recentActivity.map((activity) => (
            <div key={activity.id} className="flex items-start gap-3">
              <div
                className={`w-2 h-2 rounded-full mt-2 ${isDarkMode ? "bg-[#EF88AD]" : "bg-[#A53860]"}`}
              />
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead>
              ...
              >
                <th
                  className={`text-left py-3 px-4 text-sm font-semibold ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}
                >
                  User
                </th>
                <th
            ...
            <tbody>
              {users.map((user) => (
                ...
                >
                  ...
                  <td
                    className={`py-4 px-4 ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}
                  >
                  ...
                  <td className="py-4 px-4">
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        className={`p-2 rounded-lg ${isDarkMode ? "hover:bg-red-900/20" : "hover:bg-red-50"}`}
                        title="Suspend"
                      >
        ...
        <table className="w-full">
          ...
          <tbody>
            {recordings.map((recording) => (
              ...
              >
                <td
                  className={`py-4 px-4 font-medium ${isDarkMode ? "text-white" : "text-gray-900"}`}
                >
                  {recording.songTitle}
                </td>
                <td
                ...
                <td className="py-4 px-4">
                  <div className="flex items-center gap-2">
                    ...
                    >
                      <Star
                        className={`w-4 h-4 ${isDarkMode ? "text-yellow-500" : "text-yellow-600"}`}
                      />
                    </button>
                    <button
                      className={`p-2 rounded-lg ${isDarkMode ? "hover:bg-red-900/20" : "hover:bg-red-50"}`}
