...
import type { DropdownItem } from "@/modules/shared/components/Dropdown";
        ...
        <div className="flex items-center gap-4">
          ...
          <a
            ...
            className={`hidden md:flex items-center gap-1.5 text-xs font-medium px-3 py-1.5 
              rounded-full border border-dashed border-brand-vibrant/40 
              hover:border-brand-vibrant hover:bg-brand-vibrant/10 
              text-text-secondary hover:text-brand-vibrant transition-all duration-200`}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="12"
